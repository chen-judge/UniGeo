    ...
    def test(self):
        ...
        for loader in test_loaders:
            ...
            if 'calculation' in split[0]:
                print('Calculation BLEU Acc: ', test_results, self.calculation_acc.get_avg(), self.calculation_no_result.get_avg())
            if 'proving' in split[0]:
                print('Proving BLEU Acc: ', test_results, self.proving_acc.get_avg(), self.proving_no_result.get_avg())
